...
/// Configurable options for the default storage provided by the MIRACL Trust iOS SDK.
///
/// The default storage that the MIRACL Trust iOS SDK provides is an encrypted SQLite database stored in the `documents` directory.
public class DefaultUserStorageOptions {
    /// Name of the storage file.
    public var storageName: String = "miracl"

    /// File system path used for the default storage file.
