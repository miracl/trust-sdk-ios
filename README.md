...
```bash
.package(url: "https://github.com/miracl/trust-sdk-ios", .upToNextMajor(from: "1.13.1"))
```
...
- [API reference](https://miracl.github.io/trust-sdk-ios/documentation/miracltrust)
